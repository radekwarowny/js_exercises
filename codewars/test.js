...
indexOf(['JaCk', 'Jack', 'jack', 'jackk', 'COdewars', 'codeWars', 'abcdefgh', 'codewars'], 'codewars')
...
function price(start, soil, age) {
    ...
    if (soil in soil_o_meter == false) {
        ...
        var n_apr; // yearly appreciation
        var total = start;

        for (var i = 0; i < age; i++) { // price appreciates over given time
